...
def remotegetlocator(locatorid):
	try:
		...
		so.caseexecuteerrorlog.error('get remote locator failed,id:'+str(locatorid)+',traceback:'+traceback.format_exc())
		return False
...
def remotegetacuttype(acutid):
	try:
		...
		so.caseexecuteerrorlog.error('get remote acuttype failed,id:'+str(acutid)+',traceback:'+traceback.format_exc())
		return False